...
message = "Список забаненных пользователей в сообществе Скандал Кировоград: \n\nСписок сформирован: " + curr_date + \
          "\n\nБолее подробная информация и дата разбана - в теме по ссылке внизу.\nПричины бана указаны для каждого " \
          "участника отдельно, для того чтобы вас убрали из этого списка - необходимо:\n - придерживаться правил " \
          "сообщества \n - придерживаться правил социальной сети Вконтакте \n - написать администратору с просьбой " \
          "разбана и объяснением причины того, что заставило вас нарушить наши правила \n\nДисклеймер:\nЗачем мы " \
          "это делаем? Для того, чтобы научить комьюнити АДа - дисциплине и правилам поведения, не хотите попасть " \
          "в список - не будьте хамлом, ботом, рекламщиком, и все будет ок.\n\nЧтобы исчезнуть из этого списка, раз " \
          "вы туда попали - надо раскаяться и больше не повторять своих ошибок.\nДанный пост не преследует целей " \
          "оскорбить или затравить пользователей, он создается только для воспитательного момента, предотвращения " \
          "нарушений и создания открытости между администрацией и пользователями.\nТеперь никто просто так не " \
          "попадет в бан потому, что не нравится админу, так как все участники смогут быть адвокатами забаненного " \
          "и могут помочь ему выйти по УДО.\n\n Внимание!\n Если вы оказались в этом списке случайно, или не хотите " \
          "в нем находиться, или вас это оскорбляет, задевает ваши чувства, то свяжитесь с администрацией " \
          "сообщества, мы исправим это недоразумение, и возможно, заменим причину бана на более лояльную.\n\n " \
          "#typical_kirovohrad, #ban_bot, #tk_ban_bot\n\n" \
          "\n\n #ВождьБот Powered by #Python made by #trianglesis\n\n"

ban_msg = " == Список забаненных пользователей в сообществе Скандал Кировоград: == \n\nСписок сформирован: " \
          + curr_date + \
          "\n\n'''Более подробная информация и дата разбана - в теме по ссылке внизу.'''\nПричины бана указаны для каждого " \
          "участника отдельно, для того чтобы вас убрали из этого списка - необходимо:\n* придерживаться правил " \
          "сообщества \n* придерживаться правил социальной сети Вконтакте \n* написать администратору с просьбой " \
...
group = '80849532'
# Преданные анафеме рукой святой инквиции АДа
# https://vk.com/page-80849532_50956371
page = '50956371'
